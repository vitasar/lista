...
var gulp = require("gulp"),
  ...
  // reorder css rules in wished order
  ...
  // replace one string in the file to another.
  ...
  // transfer media queries to the end style file
  combineMq = require("gulp-combine-mq"),
  // remove files
  del = require("del"),
  // turn relative path scripts to absolute (for bower puproses)
  flatten = require("gulp-flatten"),
  // custom realization standart watch.
  // gulp doesn't notice files which created after launching gulp.
